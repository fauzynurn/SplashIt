...
import com.splashit.core.databinding.PhotoItemLayoutBinding
import com.splashit.core.ui.model.PhotoModel
import java.util.*

class PhotoAdapter(val callback: ((PhotoModel) -> Unit)? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoViewHolder {
        ...
        val binding = PhotoItemLayoutBinding.inflate(inflater, parent, false)
